<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"E:\phpstudy\PHPTutorial\WWW\bysj\public/../application/index\view\article\articleList.html";i:1528505585;}*/ ?>
...
<div class="clearfix">
 ...
 <div class="">
    <div class="border clearfix">
       ...
       <span class="r_f">共：<b><?php echo count($articlelist); ?></b>条文章</span>
     </div>
     <div class="article_list">
       ...
       <thead>
		...
		<?php foreach($articlelist as $vo): ?>
         <tr>
          <td><label><input type="checkbox" class="ace" value="<?php echo $vo['gid']; ?>"><span class="lbl"></span></label></td>
...
function delbatch() {
    ...
    if (gids.length > 0){
        $.ajax({
            url:'/index.php/index/delArticleListBatch.html',
            type:'POST',
            dataType:'json',
            data:'gids='+gids,
            success:function (val) {
