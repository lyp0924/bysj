<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/data/www/default/bysj/public/../application/index/view/roles/roleAdd.html";i:1525516475;}*/ ?>
...
function article_save_submit(){
    ...
    if(num>0){
        ...
        $.ajax({
            ...
            type:'POST',
            dataType:'json',
            data:'name='+$("#form-field-1").val()+'&status='+$("#form_select").val()+'&parent='+parent+'&role_id='+"<?php echo isset($roleMsg)?$roleMsg['role_id'] : null; ?>",
