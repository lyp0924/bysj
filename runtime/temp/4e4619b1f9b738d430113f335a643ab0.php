<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"E:\phpstudy\PHPTutorial\WWW\bysj\public/../application/index\view\users\userList.html";i:1528503741;}*/ ?>
    ...
    <div class="border clearfix"><span class="l_f"><a href="javascript:void(0)" class="btn btn-danger" onclick="delbatch()"><i class="fa fa-trash"></i> 批量删除</a></span>
     ...
     <div class="article_list">
       ...
       <thead>
        ...
        <tr>
            <td><label><input type="checkbox" class="ace" value="<?php echo $user['user_id']; ?>"><span class="lbl"></span></label></td>
