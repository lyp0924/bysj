<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"E:\phpstudy\PHPTutorial\WWW\bysj\public/../application/index\view\users\userInfo.html";i:1526297308;}*/ ?>
   ...
   <div class="admin_modify_style" id="Personal">
     <div class="type_title">管理员信息 </div>
      <div class="xinxi">
        <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">姓名： </label>
          <div class="col-sm-9"><input type="text" name="用户名" id="user_name" value="<?php echo $user['user_name']; ?>" class="col-xs-7 text_info" disabled="disabled">
    ...
    <?php foreach($userLogs as $userLog): ?>
      <tr>
        ...
        <td><?php echo $userLog['user']['user_name']; ?></td>
        <td>登录成功!</td>
        <td><?php echo $userLog['login_addr']; ?></td>
        <td><?php echo $userLog['login_ip']; ?></td>
        <td><?php echo date('Y-m-d H:i:s',$userLog['login_time']); ?></td>
      </tr>
    <?php endforeach; ?>
            ...
            layer.alert('密码不一致!',{
			 ...
			 return false;
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    dataType: 'json',
                    data: 'pwd=' + $("#Nes_pas").val() + '&user_id=<?php echo $user['user_id']; ?>&password='+$("#password").val(),
                    success:function (val) {
                        if (val.errorcode == 1) {
                            layer.msg(val.errormsg);
