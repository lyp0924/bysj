<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"E:\phpstudy\PHPTutorial\WWW\bysj\public/../application/index\view\article\articleSort.html";i:1528504783;}*/ ?>
...
<div class="margin clearfix">
 <div class="sort_style">
  <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:void(0)"id="add_page" class="btn btn-warning" onclick="add_article_sort()"><i class="fa fa-plus"></i> 添加分类</a>
        <a href="javascript:void(0)" class="btn btn-danger" onclick="delbatch()"><i class="fa fa-trash"></i> 批量删除</a>
       </span>
       <span class="r_f">共：<b><?php echo count($sortlist); ?></b>分类</span>
     </div>
     <!--分类类表-->
       ...
       <thead>
        ...
        <tbody>
		 ...
		 <?php foreach($sortlist as $vo): ?>
          <td><label><input type="checkbox" class="ace" value="<?php echo $vo['sid']; ?>"><span class="lbl"></span></label></td>
...
function delbatch() {
    ...
    if (sid.length > 0){
        $.ajax({
            url:'/index.php/index/delArticleSortBatch.html',
            type:'POST',
            dataType:'json',
            data:'sid='+sid,
            success:function (val) {
